...
public:
        ...
        CCreateContext* pContext = NULL)
    {
        ...
        {
            TRACE(_T("COX3DTabViewContainer::OnCreate: failed to register the control with COleDropTarget\n"));
    ...
    BOOL AddPage(CRuntimeClass* pClass, CCreateContext* pContext, 
        LPCTSTR lpszTitle=NULL, int nImage=-1) 
    {
        return InsertPage(GetPageCount(),pClass,pContext,lpszTitle,nImage);
    }


    BOOL AddPage(CWnd* pWnd, UINT nTitleID, const int nImage=-1) 
    { 
       CString sCaption;
       ...
       return InsertPage(GetPageCount(),pWnd,(LPCTSTR)sCaption,nImage); 
    }
    ...
    BOOL AddPage(CWnd* pWnd, LPCTSTR lpszTitle=NULL, const int nImage=-1) { 
        return InsertPage(GetPageCount(),pWnd,lpszTitle,nImage); 
    }
    ...
    //              function if you have to add any generic window into the 
    //              3DTabView container.
    virtual BOOL InsertPage(int nIndex, CWnd* pWnd, LPCTSTR lpszTitle=NULL, int nImage=-1);
