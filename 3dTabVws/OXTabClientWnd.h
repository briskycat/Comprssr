...
const DWORD DEFAULT_TABCTRLSTYLE=TCS_MULTILINE|TCS_BOTTOM|TCS_HOTTRACK|
	TCS_SCROLLOPPOSITE|TCS_RIGHTJUSTIFY;
...
protected:
	...
	{
		return InsertTabItem(m_arrTab.GetSize(),pChildWnd,bRedraw,bOnlyVisible);
	}
	// Adds new tab item for the specified window
